...
public class TagTableTools {
  [McpServerTool, Description("Returns a list of all PLC tag tables of a specific TIA project.")]
  ...
  [McpServerTool, Description("Returns tags, user constants and system constants of a PLC tag table.")]
