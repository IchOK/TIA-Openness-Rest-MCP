...
public class DBTools {
  ...
  public static async Task<McpApiResponse> ListDbs(
    ...
    try {
      ...
      string route = $"{DBRoutes.List}?processId={processId}&projectName={safeProjectName}";
  ...
  [McpServerTool, Description("Returns the Date of a Datablock")]
  public static async Task<McpApiResponse> GetDb(
    [Description("The ProcessId of the TIA Portal instance")] int processId,
    [Description("The name of the project")] string projectName,
    [Description("The name of the Datablock")] string blockName,
    ...
    try {
      ...
      string safeProjectName = Uri.EscapeDataString(projectName);
      string route = $"{DBRoutes.Get}?processId={processId}&projectName={safeProjectName}&blockName={Uri.EscapeDataString(blockName)}&deviceName={Uri.EscapeDataString(deviceName)}&deviceItemName={Uri.EscapeDataString(deviceItemName)}";
